...
- 숫자 열거형 : 자동으로 가장 적절한 숫자를 추론해 저장
- 이종 열거형 : 문자, 숫자 혼합하여 사용 가능
...
- 타입별칭과 비슷하게 새로운 타입을 정의하는 또 다른 방법

- 객체, 함수의 파라미터, 클래스 등에 사용할 수 있으며, 상호 간에 정의한 약속 혹은 규칙을 의미

- `interface 인터페이스이름 { 속성: 타입; }`으로 정의
